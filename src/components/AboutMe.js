        ...
        <Box sx={{ fontFamily: 'Helvetica', m: 2 }}>
            <Grid container spacing={2}>
                <Grid item xs={12} md={8}>
                    <Typography gutterBottom variant="h5" component="div" sx={{ mb: 2, textAlign: 'left', fontSize: '2em' }}>
                        About me
                    </Typography>
                    <Typography variant="body2" sx={{ fontSize: '1.3em', lineHeight: '1.5', color: '#333', fontWeight: '500', fontFamily: '"Antonio", Sans-serif', textAlign: 'left' }}>
                        {description}
                    </Typography>
                </Grid>
                <Grid item xs={12} md={4}>
                    <Avatar alt="Profile Picture" src="/static/images/avatar/1.jpg" sx={{ width: '100%', height: 'auto' }} />
                </Grid>
            </Grid>
        </Box>
    );
